...
Goals:
--Make site landing page multilingual greeting
--Then, introduction where person chooses animal and color scheme
-----This will be in a sticky/fixed nav after the first choice of color scheme and animal
--Then, site w/ home page, about, resume, and links to code samples
